...
public class RestaurantTest {
	...
	public void testStringToJSONArray() throws JSONException {
		...
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray(str), true);
	}
	@Test
	public void testStringToJSONArrayCornerCases() throws JSONException {
		JSONArray jsonArray = new JSONArray();
		JSONAssert.assertEquals(jsonArray, Restaurant.stringToJSONArray(""), true);
		JSONAssert.assertEquals("[\"Janpanese\",\"Chinese or Italian\"]", Restaurant.stringToJSONArray("Janpanese,Chinese/Italian"), true);
	}
